...
ImageReader::~ImageReader() {
  // Destroy barcode reader
  DBR_DestroyInstance(barcode_reader);
...
void ImageReader::WriteFile(AImage* image) {
  ...
  if (file && data && len) {
    ...
    DBR_DecodeFile(barcode_reader, fileName.c_str(), "");
...
void ImageReader::DrawFrame(void) {
