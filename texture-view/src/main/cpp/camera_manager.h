...
struct CaptureRequestInfo {
  ...
  // For Image Reader
  ANativeWindow* yuvWindow;
  ACameraOutputTarget* yuvTarget;
  ACaptureSessionOutput* yuvOutput;
};
...
class NDKCamera {
 ...
 public:
  ...
  void CreateSession(ANativeWindow* previewWindow, ANativeWindow* yuvWindow);
